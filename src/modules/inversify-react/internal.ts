...
const InversifyReactContext =
  createContext<InversifyReactContextValue>(undefined)
...
function createProperty(
  target: Component,
  name: string,
  type: interfaces.ServiceIdentifier<unknown>,
...
export type { DiClassAdministration, DiInstanceAdministration, PropertyOptions }
export {
